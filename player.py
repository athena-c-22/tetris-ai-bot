...
class GoodPlayer(Player):
    ...
    def score_board(self, board):
        ...
        score = 1000 - 20.110954195982956 * holes - 0.46484750255165963 * len(board.cells) - 1.7338268167957067 * greatest_height - 0.9821726250852962 * bumpiness + 3.580114847254702 * lines_cleared - 100.96014008539409 * well_penalty + 0.2298762066943576 * tetris_potential # The weights were generated using a genetic algorithm written by myself. The initial values used to generate the first population were chosen by myself based on my observations and through trial-and-error over the course of this coursework. For example, I noticed that despite the block structure having a smooth profile, if there are holes, it is hard to clear lines. So, I increased the relative weight of 'holes' to bumpiness.
        return score
